...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['delete_id'])) {
    $Patient = new Patient();
    $deletedRows = $Patient->deletePatient($_POST['delete_id']);
        ...
        <div class="container">
            ...
            <?php foreach ($data as $row): ?>
                <div class="patient-data">
                    <div><span>PatientId:</span> <span><?php echo $row['patientID']; ?></span></div>
                    <div><span>Naam:</span> <span><?php echo $row['naam']; ?></span></div>
                    <div><span>Achternaam:</span> <span><?php echo $row['achternaam']; ?></span></div>
                    <div><span>Geboortedatum:</span> <span><?php echo $row['geboortedatum']; ?></span></div>
                    <div><span>Woonadres:</span> <span><?php echo $row['woonadres']; ?></span></div>
                    <div><span>Telefoonnummer:</span> <span><?php echo $row['telefoonnummer']; ?></span></div>
                    <div><span>Email:</span> <span><?php echo $row['email']; ?></span></div>
                    <div><span>Verzekeringsnummer:</span> <span><?php echo $row['verzekeringnummer']; ?></span></div>
                    <div class="action-links">
                        <a href="edit-patient.php?id=<?php echo $row['patientID']; ?>">Bewerken</a>
                        <form method="POST" style="display:inline;">
                            <input type="hidden" name="delete_id" value="<?php echo $row['patientID']; ?>">
