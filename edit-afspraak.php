...
try {
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $Afspraak->updateAfspraak($_POST['naam'], $_POST['achternaam'],$_POST['datum'],$_POST['tijd'],  $_POST['tandarts'], $_POST['afspraakID']);
        header("Location:view-afspraak.php?process=update");
    }
} catch (\Exception $e) {
